...
const productRow = (product: Product) => ({
  ...
  is_house_blend: Boolean(product.isHouseBlend),
  house_blend_order: product.houseBlendOrder ?? null,
  house_blend_label: nullable(product.houseBlendLabel),
...
const menuItemRow = (item: MenuItem) => ({
  ...
  hero_content_mode: item.heroContentMode ?? "image_with_menu_info",
  custom_overlay_title: nullable(item.customOverlayTitle),
...
const heroContentRow = (heroContent: HeroContent) => ({
  ...
  hero_content_mode: heroContent.heroContentMode ?? "image_with_menu_info",
  custom_overlay_title: nullable(heroContent.customOverlayTitle),
  custom_overlay_text: nullable(heroContent.customOverlayText),
  overlay_fields: heroContent.overlayFields ?? ["name", "taste_note"],
