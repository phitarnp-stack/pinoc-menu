...
export const passportBadgeDefinitions: PassportBadgeDefinition[] = [
  {
    ...
    lockedDescription: "Add a cup with origin details to begin this path.",
  },
  {
    id: "first-flavor",
    name: "First Flavor",
  ...
  },
  {
    ...
    lockedDescription: "Add a coffee or milk coffee to My Cup.",
  },
  {
    id: "matcha-discovery",
    name: "Matcha Discovery",
    description: "You added matcha to your discovery journal.",
    lockedDescription: "Add a matcha menu item to My Cup.",
  },
  {
    id: "cocoa-discovery",
    name: "Cocoa Discovery",
    description: "You collected a craft cocoa experience.",
    lockedDescription: "Add a craft cocoa menu item to My Cup.",
  },
  {
    id: "special-explorer",
    name: "Special Explorer",
    description: "You explored a Pinoc special.",
    lockedDescription: "Add a special menu item to My Cup.",
  },
  {
    id: "discovery-journal",
    name: "Discovery Journal",
    description: "Five cups now live in My Cup.",
