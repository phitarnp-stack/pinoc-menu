...
export const heroContent: HeroContent = {
  ...
  customOverlayTitle: "",
  customOverlayText: "",
  overlayFields: ["name", "taste_note"],
  tastingNote:
    "Seasonal pours, precise texture, and quiet signatures for the cup your mood is asking for.",
  ctaLabel: "Find Your Cup",
  ctaHref: "/find-your-cup",
  featuredProductId: "product-ethiopia-guji-natural",
  featuredSpecialId: "item-orange-espresso-tonic",
};
